                    ...
                    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-4 sm:p-6 lg:p-8">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="mt-6 -mx-4 sm:mx-0 px-4 sm:px-0 overflow-x-auto">
                                <div class="flex items-center text-xs pb-2 min-w-max">
                                    {{-- Step 1 --}}
                                    <div class="flex items-center progress-step" data-step="1">
                                        <div
                                            class="w-6 h-6 sm:w-8 sm:h-8 bg-primary-900 text-white rounded-full flex items-center justify-center font-semibold step-indicator flex-shrink-0">
                                            1</div>
                                        <span
                                            class="ml-1 sm:ml-2 font-medium text-gray-900 hidden md:inline whitespace-nowrap">Personal</span>
                                    </div>
                                    <div class="h-1 bg-gray-200 mx-1 sm:mx-2 w-6 sm:w-6 md:w-8 flex-shrink-0"></div>

                                    {{-- Step 2 --}}
                                    <div class="flex items-center progress-step" data-step="2">
                                        <div
                                            class="w-6 h-6 sm:w-8 sm:h-8 bg-gray-200 text-gray-500 rounded-full flex items-center justify-center font-semibold step-indicator flex-shrink-0">
                                            2</div>
                                        <span
                                            class="ml-1 sm:ml-2 text-gray-500 hidden md:inline whitespace-nowrap">Family</span>
                                    </div>
                                    <div class="h-1 bg-gray-200 mx-1 sm:mx-2 w-6 sm:w-6 md:w-8 flex-shrink-0"></div>
                                    ...
                                    <div class="flex items-center progress-step" data-step="3">
                                        <div
                                            ...
                                            3</div>
                                        <span
                                            class="ml-1 sm:ml-2 text-gray-500 hidden md:inline whitespace-nowrap">Education</span>
                                    </div>
                                    <div class="h-1 bg-gray-200 mx-1 sm:mx-2 w-6 sm:w-6 md:w-8 flex-shrink-0"></div>
                                    ...
                                    <div class="flex items-center progress-step" data-step="4">
                                        <div
                                            ...
                                            4</div>
                                        <span
                                            class="ml-1 sm:ml-2 text-gray-500 hidden md:inline whitespace-nowrap">Experience</span>
                                    </div>
                                    <div class="h-1 bg-gray-200 mx-1 sm:mx-2 w-6 sm:w-6 md:w-8 flex-shrink-0"></div>
                                    ...
                                    <div class="flex items-center progress-step" data-step="5">
                                        <div
                                            ...
                                            5</div>
                                        <span
                                            class="ml-1 sm:ml-2 text-gray-500 hidden md:inline whitespace-nowrap">Questions</span>
                                    </div>
                                    <div class="h-1 bg-gray-200 mx-1 sm:mx-2 w-6 sm:w-6 md:w-8 flex-shrink-0"></div>

                                    {{-- Step 6 --}}
                                    <div class="flex items-center progress-step" data-step="6">
                                        <div
                                            class="w-6 h-6 sm:w-8 sm:h-8 bg-gray-200 text-gray-500 rounded-full flex items-center justify-center font-semibold step-indicator flex-shrink-0">
                                            6</div>
                                        <span
                                            class="ml-1 sm:ml-2 text-gray-500 hidden md:inline whitespace-nowrap">Documents</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form action="{{ route('jobs.submit', $job->id) }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-step hidden" data-step="5">
                                @include('candidate.applications-section.partials.questions')
                            </div>

                            {{-- Step 6: Documents & Cover Letter --}}
